...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Caveat:wght@400;700&family=Rubik+Marker+Hatch&family=JetBrains+Mono:wght@400;500&family=Inter:wght@400;500&display=swap",
      },
    ],
  }),
